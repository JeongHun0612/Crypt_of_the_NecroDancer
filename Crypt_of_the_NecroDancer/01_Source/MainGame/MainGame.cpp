...
void MainGame::initImage()
{
	...
	IMAGEMANAGER->addImage("slot_item", "Resources/Images/HUD/Slot_Item2.bmp", 60, 76, true, RGB(255, 0, 255));
	IMAGEMANAGER->addImage("slot_bomb", "Resources/Images/HUD/Slot_Bomb2.bmp", 60, 76, true, RGB(255, 0, 255));
	...
	IMAGEMANAGER->addFrameImage("effect_explosion", "Resources/Images/Effect/effect_explosion.bmp", 1536, 192, 8, 1, true, RGB(255, 0, 255));
